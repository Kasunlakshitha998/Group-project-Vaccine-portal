        ...
        <div class="main-content">
            ...
            <div style="display: flex;" >
                <form method="post" action="contact_process.php" class="main-form">
                    ...
                    <div class="form-field-cont">
                        <input type="email" id="email" name="email" class="form-field" placeholder="Mail Address" required>
                    </div>
                    <div class="form-field-cont">
                        <input type="tel" id="contact" name="contact" class="form-field" placeholder="Contact Number" required>
                    </div>
                    <div class="form-field-cont">
                        <textarea class="form-field" id="content" name="content" placeholder="Type what you want...." rows="5" required></textarea>
                    </div>
                    <div style="display: flex;justify-content: center;align-items: center;">
                        <button id="send_re" name="submit" type="submit" class="form-btn">Submit</button>
                    </div>
                </form>
